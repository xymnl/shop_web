<footer class="page-footer font-small cyan darken-3">
            ...
            <div class="row align-items-center footer-title">
                <div class="text-lg-start text-center">
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item"><a href="#!"><i class="bi bi-credit-card-2-front-fill"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="border-top py-4">
            <div class="row align-items-center">
                <div class="col-md-6"><span class="small text-muted">Copyright 2023 © FreshCart eCommerce HTML Template.  All rights reserved.</span></div>
                <div class="col-md-6">
