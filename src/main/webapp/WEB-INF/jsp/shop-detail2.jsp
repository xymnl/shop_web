...
<div class="row">
	<div class="col-md-6">
		...
		<div class="product" id="product">
			<div class="zoom" onmousemove="zoom(event)" style="background-image:url(/resources/imgs/product-single-img-1.jpg)">
				<img src="/resources/imgs/product-single-img-1.jpg" alt="">
			</div>
			<div>
				<div class="zoom" onmousemove="zoom(event)" style="background-image:url(/resources/imgs/product-single-img-2.jpg)">
					<img src="/resources/imgs/product-single-img-2.jpg" alt="">
				</div>
			</div>
			<div>
				<div class="zoom" onmousemove="zoom(event)" style="background-image:url(/resources/imgs/product-single-img-3.jpg)">
					<img src="/resources/imgs/product-single-img-3.jpg" alt="">
				</div>
			</div>
			<div>
				<div class="zoom" onmousemove="zoom(event)" style="background-image:url(/resources/imgs/product-single-img-4.jpg)">
					<img src="/resources/imgs/product-single-img-4.jpg" alt="">
				</div>
			</div>
		</div>
